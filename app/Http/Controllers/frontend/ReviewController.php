...
class ReviewController extends Controller
{
   ...
   public function create(Request $request)
   {
    ...
    {
        return redirect()->back()->with('status',"The lin you followed was broken");
    }
    ...
    $user_review=$request->input('user_review');
     if($user_review !="")
     {
        ...
        if($review)
        {
            ...
            $review->update();
            return redirect('category/'.$review->product->category->slug.'/'.$review->product->slug)->with('status',"Product Review Updated Successfully");
        }
        else{
            return redirect()->back()->with('status',"The lin you followed was broken");
